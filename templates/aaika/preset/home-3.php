...
======================================= -->
  ...
  if($this->countModules('js-slideshownew')) { ?>
    ...
    <?php } ?>
    <?php if($this->countModules('home3_js-features35')) { ?>
    <div class="clearfix"></div>
    <jdoc:include type="modules" name="home3_js-features35" style="nomoduletablediv" />
    <?php } ?>
    <?php if($this->countModules('home3_js-features36')) { ?>
    <div class="clearfix"></div>
    <jdoc:include type="modules" name="home3_js-features36" style="nomoduletablediv" />
    <?php } ?>
    <?php if($this->countModules('home3_js-recentwork')) { ?>
    <div class="clearfix"></div>
    <jdoc:include type="modules" name="home3_js-recentwork" style="nomoduletablediv" />
    <?php } ?>
