...
======================================= -->
  ...
  <div class="mstslider">
    ...
    <?php } ?>
    <?php if($this->countModules('home12_js-features48')) { ?>
    <div class="clearfix"></div>
    <jdoc:include type="modules" name="home12_js-features48" style="nomoduletablediv" />
    <?php } ?>
    <?php if($this->countModules('home7_js-features33')) { ?>
    <div class="clearfix"></div>
    <jdoc:include type="modules" name="home7_js-features33" style="nomoduletablediv" />
    <?php } ?>
    <?php if($this->countModules('home12_js-features39')) { ?>
    <div class="clearfix"></div>
    <jdoc:include type="modules" name="home12_js-features39" style="nomoduletablediv" />
    <?php } ?>
    <?php if($this->countModules('home3_js-features11')) { ?>
    <div class="clearfix"></div>
    <jdoc:include type="modules" name="home3_js-features11" style="nomoduletablediv" />
    <?php } ?>
    <?php if($this->countModules('home12_js-features49')) { ?>
    <div class="clearfix"></div>
    <jdoc:include type="modules" name="home12_js-features49" style="nomoduletablediv" />
    <?php } ?>
