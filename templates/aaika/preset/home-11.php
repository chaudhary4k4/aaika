...
======================================= -->
  ...
  if($this->countModules('js-slideshow10')) { ?>
   <div class="mstslider">
    ...
    <?php } ?>
    <?php if($this->countModules('home11_js-features47')) { ?>
    <div class="clearfix"></div>
    <jdoc:include type="modules" name="home11_js-features47" style="nomoduletablediv" />
    <!-- end features section 3 -->
    <?php } ?>
    <?php if($this->countModules('home11_js-slider')) { ?>
    <div class="clearfix"></div>
    <jdoc:include type="modules" name="home11_js-slider" style="nomoduletablediv" />
    <!-- end features section 3 -->
    <?php } ?>
    <?php if($this->countModules('home11_js-features44')) { ?>
    <div class="clearfix"></div>
    <jdoc:include type="modules" name="home11_js-features44" style="nomoduletablediv" />
    <!-- end features section 3 -->
    <?php } ?>
