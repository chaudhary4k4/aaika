...
======================================= -->
  ...
  ?>
    ...
    <?php } ?>
    <?php if($this->countModules('home2_js-features12')) { ?>
    <div class="clearfix"></div>
    <jdoc:include type="modules" name="home2_js-features12" style="nomoduletablediv" />
    <!-- end features section 12 -->
    <?php } ?>
    <?php if($this->countModules('home2_js-features33')) { ?>
    <div class="clearfix"></div>
    <jdoc:include type="modules" name="home2_js-features33" style="nomoduletablediv" />
    <?php } ?>
    <?php if($this->countModules('home2_js-features34')) { ?>
    <div class="clearfix"></div>
    <jdoc:include type="modules" name="home2_js-features34" style="nomoduletablediv" />
    <?php } ?>
    <?php if($this->countModules('home2_js-features3')) { ?>
    <div class="clearfix"></div>
    <jdoc:include type="modules" name="home2_js-features3" style="nomoduletablediv" />
    <?php } ?>
    <?php if($this->countModules('home2_js-parallax5')) { ?>
    <div class="clearfix"></div>
    <jdoc:include type="modules" name="home2_js-parallax5" style="nomoduletablediv" />
    <?php } ?>
    <?php if($this->countModules('home2_js-features6')) { ?>
    <div class="clearfix"></div>
    <jdoc:include type="modules" name="home2_js-features6" style="nomoduletablediv" />
    <?php } ?>
    ...
    <?php } ?>
    <?php if($this->countModules('home2_js-features14')) { ?>
    <div class="clearfix"></div>
    <jdoc:include type="modules" name="home2_js-features14" style="nomoduletablediv" />
    <?php } ?>
