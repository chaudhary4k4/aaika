...
======================================= -->
  ...
  ?>
    ...
    <?php } ?>
    <?php if($this->countModules('home8_js-features43')) { ?>
    <div class="clearfix"></div>
    <jdoc:include type="modules" name="home8_js-features43" style="nomoduletablediv" />
    <?php } ?>
    <?php if($this->countModules('home8_js-features44')) { ?>
    <div class="clearfix"></div>
    <jdoc:include type="modules" name="home8_js-features44" style="nomoduletablediv" />
    <?php } ?>
    <?php if($this->countModules('home8_js-features12')) { ?>
    <div class="clearfix"></div>
    <jdoc:include type="modules" name="home8_js-features12" style="nomoduletablediv" />
    <?php } ?>
