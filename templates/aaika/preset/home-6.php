...
======================================= -->
  ...
  ?>
    ...
    <?php } ?>
    <?php if($this->countModules('home6_js-features41')) { ?>
    <div class="clearfix"></div>
    <jdoc:include type="modules" name="home6_js-features41" style="nomoduletablediv" />
    <?php } ?>
    <?php if($this->countModules('js-recentworks')) { ?>
    <div class="clearfix"></div>
    <jdoc:include type="modules" name="js-recentworks" style="nomoduletablediv" />
    <?php } ?>
    <?php if($this->countModules('home6_js-features42')) { ?>
    <div class="clearfix"></div>
    <jdoc:include type="modules" name="home6_js-features42" style="nomoduletablediv" />
    <?php } ?>
