...
======================================= -->
  ...
  if($this->countModules('js-slideshownew')) { ?>
    ...
    <?php } ?>
    <?php if($this->countModules('home10_js-features45')) { ?>
    <div class="clearfix"></div>
    <jdoc:include type="modules" name="home10_js-features45" style="nomoduletablediv" />
    <!-- end features section 3 -->
    <?php } ?>
    <?php if($this->countModules('home10_js-features46')) { ?>
    <div class="clearfix"></div>
    <jdoc:include type="modules" name="home10_js-features46" style="nomoduletablediv" />
    <!-- end features section 3 -->
    <?php } ?>
    ...
    <?php } ?>
    <?php if($this->countModules('home10_js-parallax7')) { ?>
    <div class="clearfix"></div>
    <jdoc:include type="modules" name="home10_js-parallax7" style="nomoduletablediv" />
    <?php } ?>
