...
======================================= -->
 ...
 if($this->countModules('js-slideshownew')) { ?>
  ...
  ?>
    ...
    <?php } ?>
    <?php if($this->countModules('home5_js-features7')) { ?>
    <div class="clearfix"></div>
    <jdoc:include type="modules" name="home5_js-features7" style="nomoduletablediv" />
    <?php } ?>
    <?php if($this->countModules('home5_js-features39')) { ?>
    <div class="clearfix"></div>
    <jdoc:include type="modules" name="home5_js-features39" style="nomoduletablediv" />
    <?php } ?>
    <?php if($this->countModules('home5_js-features40')) { ?>
    <div class="clearfix"></div>
    <jdoc:include type="modules" name="home5_js-features40" style="nomoduletablediv" />
    <?php } ?>
    <?php if($this->countModules('home5_js-features9')) { ?>
    <div class="clearfix"></div>
    <div class="clearfix harrow_line2"></div>
    <div class="clearfix"></div>
    <jdoc:include type="modules" name="home5_js-features9" style="nomoduletablediv" />
