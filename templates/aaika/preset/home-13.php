...
======================================= -->
  ...
  <div class="mstslider">
    ...
    <?php } ?>
    <?php if($this->countModules('home13_js-features45')) { ?>
    <div class="clearfix"></div>
    <jdoc:include type="modules" name="home13_js-features45" style="nomoduletablediv" />
    <?php } ?>
    <?php if($this->countModules('home13_js-features12')) { ?>
    <div class="clearfix"></div>
    <jdoc:include type="modules" name="home13_js-features12" style="nomoduletablediv" />
    <?php } ?>
    <?php if($this->countModules('home13_js-features51')) { ?>
    <div class="clearfix"></div>
    <jdoc:include type="modules" name="home13_js-features51" style="nomoduletablediv" />
    <?php } ?>
    <?php if($this->countModules('home13_js-features52')) { ?>
    <div class="clearfix"></div>
    <jdoc:include type="modules" name="home13_js-features52" style="nomoduletablediv" />
    <?php } ?>
