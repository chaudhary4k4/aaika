...
======================================= -->
 ...
 if($this->countModules('js-slideshownew')) { ?>
  ...
  ?>
    ...
    <?php } ?>
    <?php if($this->countModules('home4_js-features37')) { ?>
    <div class="clearfix"></div>
    <jdoc:include type="modules" name="home4_js-features37" style="nomoduletablediv" />
    <?php } ?>
    <?php if($this->countModules('home4_js-features33')) { ?>
    <div class="clearfix"></div>
    <jdoc:include type="modules" name="home4_js-features33" style="nomoduletablediv" />
    <?php } ?>
