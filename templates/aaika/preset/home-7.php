...
======================================= -->
    <?php
 if($this->countModules('js-slideshownew')) { ?>
  <div class="mstslider">
    <jdoc:include type="modules" name="js-slideshownew" style="nomoduletablediv" />
  </div>
    <?php }
  ?>
    <!-- end slider -->
    ...
    <?php } ?>
    <?php if($this->countModules('home7_js-ultimate')) { ?>
    <div class="clearfix"></div>
    <jdoc:include type="modules" name="home7_js-ultimate" style="nomoduletablediv" />
    <?php } ?>
    <?php if($this->countModules('home7_js-counters')) { ?>
    <div class="clearfix"></div>
    <jdoc:include type="modules" name="home7_js-counters" style="nomoduletablediv" />
    <?php } ?>
    <?php if($this->countModules('home7_js-features53')) { ?>
    <div class="clearfix"></div>
    <jdoc:include type="modules" name="home7_js-features53" style="nomoduletablediv" />
    <?php } ?>
    <?php if($this->countModules('home7_js-features14')) { ?>
    <div class="clearfix"></div>
    <jdoc:include type="modules" name="home7_js-features14" style="nomoduletablediv" />
    <?php } ?>
    <?php if($this->countModules('home7_js-features33')) { ?>
    <div class="clearfix"></div>
    <jdoc:include type="modules" name="home7_js-features33" style="nomoduletablediv" />
    <?php } ?>
    <?php if($this->countModules('home4_js-features38')) { ?>
    <div class="clearfix"></div>
    <jdoc:include type="modules" name="home4_js-features38" style="nomoduletablediv" />
    <?php } ?>
