    ...
    <header class="header <?php echo $innerpages; ?>">
      <div class="container"> 
        ...
        <div class="logo">
          ...
          <?php } else { ?>
          <a href="index.php"><img src="<?php echo $logo; ?>" alt="logo1"></a>
          <?php } ?>
        </div>
...
======================================= -->
    <?php 
  if($this->countModules('js-slideshow7')) { ?>
    <jdoc:include type="modules" name="js-slideshow7" style="nomoduletablediv" />
    <?php }  ?>
    <!-- end slider -->
