...
======================================= -->
  ...
  if($this->countModules('js-slideshownew')) { ?>
   <div class="mstslider">
    ...
    <?php } ?>
    <?php if($this->countModules('home9_js-features3')) { ?>
    <div class="clearfix"></div>
    <jdoc:include type="modules" name="home9_js-features3" style="nomoduletablediv" />
    <!-- end features section 3 -->
    <?php } ?>
    <?php if($this->countModules('home9_js-info')) { ?>
    <div class="clearfix"></div>
    <jdoc:include type="modules" name="home9_js-info" style="nomoduletablediv" />
    <!-- end features section 3 -->
    <?php } ?>
    <?php if($this->countModules('home9_js-parallax6')) { ?>
    <div class="clearfix"></div>
    <jdoc:include type="modules" name="home9_js-parallax6" style="nomoduletablediv" />
    <!-- end features section 3 -->
    <?php } ?>
