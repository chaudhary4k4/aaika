...
<div class="right">
  ...
  <div class="cmc-saved" style="display:none"> <?php echo JText::_($params->get('thankyou')); ?> </div>
  <form action="<?php echo JRoute::_('index.php?option=com_cmc&format=raw&task=subscription.save'); ?>" method="post"
    ...
    <div class="help-inline alert alert-error cmc-exist hide"> <?php echo JText::sprintf('MOD_CMC_YOU_ARE_ALREADY_SUBSCRIBED', ''); ?> <a href=""><?php echo JText::_('MOD_CMC_CLICK_HERE_TO_UPDATE'); ?></a> </div>
    <?php endif; ?>
    <?php endforeach; ?>
    <?php endforeach; ?>
    <button class="btn btn-default validate input_submit" type="submit"> <?php echo JText::_('MOD_CMC_SUBSCRIBE'); ?> <img width="16" height="16" class="cmc-spinner" style="display: none;"
			     src="<?php echo JURI::root(); ?>media/mod_cmc/images/loading-bubbles.svg" alt="subscribe"> </button>
    <div class="row-fluid">
