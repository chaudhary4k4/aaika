...
<div class="content_fullwidth less2">
  <div class="aaika_form <?php echo $this->pageclass_sfx?>">
    ...
    <?php endif; ?>
    <form id="user-registration" action="<?php echo JRoute::_('index.php?option=com_users&task=remind.remind'); ?>" method="post" class="form-validate form-horizontal sky-form2">
      <header>Username recovery</header>
