...
<div class="content_fullwidth less2">
  <div class="aaika_form <?php echo $this->pageclass_sfx?>">
    ...
    <?php endif; ?>
    <form action="<?php echo JRoute::_('index.php?option=com_users&task=user.logout'); ?>" method="post" class="sky-form2" >
      <header> <?php echo $this->escape($this->params->get('page_heading')); ?> </header>
      <footer>
        <button type="submit" class="subbutton"><?php echo JText::_('JLOGOUT'); ?></button>
      </footer>
