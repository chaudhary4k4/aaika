...
<div id="grid-container4" class="cbp-l-grid-blog two">
  <?php if($count>0) { ?>
  <ul>
      ...
      <div class="cbp-caption-activeWrap">
        <div class="cbp-l-caption-alignCenter">
          <div class="cbp-l-caption-body">
            <div class="cbp-l-caption-text"><?php echo JText::_('PREVIEW'); ?></div>
          </div>
        </div>
      </div>
      </a> <a href="<?php echo $item->urls->urla; ?>" class="polinks"><?php echo $item->title; ?></a>
