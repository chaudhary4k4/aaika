...
<div class="recent_works2">
  <?php if($count>0){ ?>
  <?php if($show_filter){ ?>
  <div id="filters-container7" class="cbp-l-filters-alignCenter">
    ...
    /
    <div data-filter=".<?php echo modSPPortfolioJHelper::slug($value) ?>" class="cbp-filter-item"> <?php echo ucfirst(trim($value)) ?>
      <div class="cbp-filter-counter"></div>
    </div>
    <?php } ?>
  </div>
  <?php } ?>
  <?php } ?>
  <div id="grid-container7" class="cbp-l-grid-fullScreen three">
    <?php if($count>0) { ?>
    <ul>
