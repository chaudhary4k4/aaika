		...
		public function putSliderBase($sliderID){
			...
			try{
				...
				if($this->jsToBody == true){
					$urlIncludeJSTools = GlobalsRevSlider::$url_item_plugin."js/jquery.themepunch.tools.min.js";
					...
					$urlIncludeJS = GlobalsRevSlider::$url_item_plugin."js/jquery.themepunch.revolution.min.js";
					$htmlBeforeSlider .= "<script type='text/javascript' src='$urlIncludeJS'></script>\n";
				}
