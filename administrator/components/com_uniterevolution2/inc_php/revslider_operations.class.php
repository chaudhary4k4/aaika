<?php
	...
	class RevOperations extends UniteElementsBaseRev{
		...
		*/
		...
		<textarea id="rev_head_content" readonly style="width: 100%; height: 100px; color:#3498db"><?php echo $head_content; ?></textarea>
		...
		<textarea id="rev_style_content" readonly style="width: 100%; height: 100px;"><?php echo $style_content; ?></textarea>
		...
		<textarea id="rev_the_content" readonly style="width: 100%; height: 100px;"><?php echo $content; ?></textarea>
		...
		<textarea id="rev_script_content" readonly style="width: 100%; height: 100px;"><?php echo $script_content; ?></textarea>
